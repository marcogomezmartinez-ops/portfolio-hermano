...
# iShares Physical Gold via Yahoo Finance (IE00B4ND3602.IR cotiza en EUR)
try:
    r_gold = requests.get('https://query1.finance.yahoo.com/v8/finance/chart/IE00B4ND3602.IR?interval=1d&range=1d',
                     headers={'User-Agent': 'Mozilla/5.0'}, timeout=15)
