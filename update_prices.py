...
# iShares Physical Gold via Yahoo Finance (IGLN.DE cotiza en EUR en Xetra)
try:
    r_gold = requests.get('https://query1.finance.yahoo.com/v8/finance/chart/IGLN.DE?interval=1d&range=1d',
                     headers={'User-Agent': 'Mozilla/5.0'}, timeout=15)
